...
## Initiate Request
$accountId = '17017'  ### ACCOUNT ID IS STATED IN ACCOUNT INFORMATION
$reportId = '48696'

$headers = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
$headers.Add("Authorization", "Bearer $accessToken")

$response = Invoke-RestMethod "$url/api/v3/accounts/$accountId/reports/$reportId" -Method 'GET' -Headers $headers
